<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="728" height="90" id="FlashID2" title="banner-revistas">
    <param name="movie" value="<?php echo $html->url('../img/imagens/full-banner_intitu.swf')?>" />
    ...
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="<?php echo $html->url('../img/imagens/full-banner_intitu.swf')?>
            " width="728" height="90">
      <!--<![endif]-->
      <param name="quality" value="high" />
      <param name="wmode" value="opaque" />
